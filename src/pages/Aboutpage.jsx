  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <BackgroundBeamsWithCollision className="absolute inset-0 z-0">
        <div className="relative z-10 flex-grow py-12 px-4 sm:px-6 lg:px-8 text-white overflow-y-auto">
          <div className="w-full max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-start md:space-x-8">
              <div className="md:w-1/2 mb-8 md:mb-0">
                <h1 className="text-3xl sm:text-4xl font-bold mb-4 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 text-transparent bg-clip-text">
                  About ToDo
                </h1>
            ...
            <div className="mt-8">
              <div className="bg-neutral-900/70 shadow-lg rounded-lg p-4 max-w-lg mx-auto border-2 border-transparent bg-clip-border border-gradient-to-r from-pink-400 via-red-400 to-yellow-400">
                <h2 className="text-xl sm:text-2xl font-semibold mb-3 text-center bg-gradient-to-r from-pink-400 via-red-400 to-yellow-400 text-transparent bg-clip-text">
                  Key Features
                </h2>
